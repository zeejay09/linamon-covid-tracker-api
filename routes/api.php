...
Route::prefix('v1')->group(function() {
    ...
    Route::group(['middleware' => 'auth:api'], function() {
        ...
        Route::get('view/pui/{pui_id}', 'Api\PuiController@showPui');
        Route::put('edit/pui/{pui_id}', 'Api\PuiController@updatePui');
        Route::post('add/pums', 'Api\PumController@createPum');
        Route::delete('delete/pums', 'Api\PumController@deletePum');
        Route::get('view/pum/{pum_id}', 'Api\PumController@showPum');
        Route::put('edit/pum/{pum_id}', 'Api\PumController@updatePum');
        ...
        Route::get('view/covid-case/{covid_case_id}', 'Api\LaCovidCaseController@showCovidCase');
        Route::put('edit/covid-case/{covid_case_id}', 'Api\LaCovidCaseController@updateCovidCase');
    });
});